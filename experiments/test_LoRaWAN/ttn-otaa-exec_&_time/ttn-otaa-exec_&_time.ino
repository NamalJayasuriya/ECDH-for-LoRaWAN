...
void onEvent (ev_t ev) {
    ...
    switch(ev) {
        ...
        case EV_BEACON_TRACKED:
            ...
            break;
        case EV_JOINING:
            Serial.println("Millies START_JOINING : "+millis());
            LMIC_setDrTxpow(DR_SF9,14);
            LMIC_setAdrMode(1);
            Serial.println(F("EV_JOINING"));
            Serial.println("Millies END_JOINING : "+millis());
            
            break;
        case EV_JOINED:
            Serial.println(F("EV_JOINED"));
            {
              Serial.println("Millies JOINED : "millis());
              u4_t netid = 0;
              devaddr_t devaddr = 0;
              u1_t nwkKey[16];
              u1_t artKey[16];
              ...
              Serial.println("Millies JOIN_COMPLETED : "millis());
