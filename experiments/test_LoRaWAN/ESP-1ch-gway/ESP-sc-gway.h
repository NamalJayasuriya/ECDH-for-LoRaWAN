...
#define AP_NAME "Mystiko"
#define AP_PASSWD "20190226"
...
#define _TTNPORT 1700						// Standard port for TTN router.
#define _TTNSERVER "router.eu.thethings.network" //"52.169.766.203"//
...
#define _EMAIL "namalcreation@gmail.com"		// Owner
#define _PLATFORM "ESP8266"
#define _LAT 1.34618100
#define _LON 103.68266200
...
#if GATEWAYNODE==1
#define _DEVADDR { 0x26, 0x01, 0x18, 0x47 }
#define _APPSKEY { 0xD2, 0x72, 0xA4, 0x5E, 0x4A, 0x1B, 0xDF, 0xE9, 0x85, 0x44, 0xA4, 0x8A, 0xE2, 0xD6, 0x13, 0x38 }
#define _NWKSKEY { 0x44, 0x3E, 0xF1, 0x35, 0x05, 0xEA, 0xD2, 0xD6, 0xEC, 0x8C, 0x1F, 0x17, 0xCD, 0x8E, 0xDB, 0xEB }
